...
extension ViewController {
    ...
    func addViews() {
        ...
        // 端口
        let portLabel = UILabel(title: "端口", fontSize: 15, color: BLACK_COLOR)
        portLabel.frame = CGRect(x: 50, y: 80, width: 35, height: 15)
        // 端口
        portField = UITextField(placeholder: "请输入端口号", placeholderColor: UIColor.lightGray, placeholderFontSize: 13, textColor: BLACK_COLOR, textFontSize: 13)
        ...
        // 开始监听
        let startListen = UIButton(title: "开始监听", fontSize: 14, titleColor: .blue, selectTitleColor: .red)
        ...
        // 端口
        messageField = UITextField(placeholder: "请输入消息内容", placeholderColor: UIColor.lightGray, placeholderFontSize: 13, textColor: BLACK_COLOR, textFontSize: 13)
        ...
        // 发送消息
        let sendMsgBtn = UIButton(title: "发送消息", fontSize: 14, titleColor: UIColor.blue , selectTitleColor: .red)
